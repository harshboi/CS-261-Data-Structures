...
struct dynarray {
  void** data;
  int size;  // current number of elements  // logical size of the array
  int capacity; //  total number of elements that can be fit \\ physical size of the array
};
